...
const StoryReel = () => {
    return (
        <div className='storyReel' >
            ...
            />
            <Story
                image='https://static.vecteezy.com/system/resources/previews/002/158/536/non_2x/mobile-phone-smartphone-neon-sign-bright-glowing-symbol-on-a-brick-wall-background-neon-style-icon-vector.jpg'
                profileSrc='<img src="https://img.icons8.com/color/48/000000/user-male-skin-type-5.png"/>'
                title='Rafeh Qazi '
            />
